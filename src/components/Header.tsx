    ...
    <header className="fixed top-0 z-40 w-full border-b border-border/40 bg-background/70 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-8 text-xs uppercase tracking-[0.2em] text-muted-foreground md:flex">
          ...
          <a href="/#analysis" className="transition-colors hover:text-primary">Analysis</a>
        </nav>
        <a
          href="/#analysis"
          className="hidden rounded-full border border-primary/40 px-4 py-2 text-xs uppercase tracking-[0.18em] text-primary transition-all hover:bg-primary hover:text-primary-foreground sm:inline-block"
        >
          Free Analysis
        </a>
      </div>
